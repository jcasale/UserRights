...
public class UserRightsManagerPrivilegeTests
{
    ...
    public void ModifyPrivilege_WithGrantAndRevokeAndDryRun_ShouldWork()
    {
        ...
        // Assert.
        Assert.AreSequenceEqual(new[] { PrincipalSid2, PrincipalSid1 }, lsaUserRightsMockBuilder.Database.Keys.ToArray(), SequenceOrder.InAnyOrder);
        Assert.AreSequenceEqual(new[] { Privilege1 }, lsaUserRightsMockBuilder.Database[PrincipalSid1], StringComparer.Ordinal);
        Assert.AreSequenceEqual(new[] { Privilege2 }, lsaUserRightsMockBuilder.Database[PrincipalSid2], StringComparer.Ordinal);
    ...
    public void ModifyPrivilege_WithGrantAndRevokePatternAndDryRun_ShouldWork()
    {
        ...
        // Assert.
        Assert.AreSequenceEqual(new[] { PrincipalSidCurrent, PrincipalSid1, PrincipalSid2, PrincipalSid3 }, lsaUserRightsMockBuilder.Database.Keys.ToArray(), SequenceOrder.InAnyOrder);
        Assert.AreSequenceEqual(new[] { Privilege1 }, lsaUserRightsMockBuilder.Database[PrincipalSidCurrent], StringComparer.Ordinal);
